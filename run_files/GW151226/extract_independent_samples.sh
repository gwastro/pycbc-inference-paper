...
# The output file from running pycbc_inference using the sample script pycbc-inference-paper/run_files/GW151226/run_pycbc_inference.sh is gw151226_posteriors.hdf . We then thin the samples and store them in gw151226_posteriors_thinned.hdf .

input_file=gw151226_posteriors.hdf
...
pycbc_inference_extract_samples --verbose \
    --output-file gw151226_posteriors_thinned.hdf \
