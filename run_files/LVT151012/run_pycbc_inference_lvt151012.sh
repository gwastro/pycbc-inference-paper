...
#wget https://www.gw-openscience.org/LVT151012data/H-H1_LOSC_16_V2-1128676852-4096.gwf
#wget https://www.gw-openscience.org/LVT151012data/L-L1_LOSC_16_V2-1128676852-4096.gwf
...
pycbc_output_file=lvt151012_posteriors.hdf

# data
FRAMES="H1:H-H1_LOSC_16_V2-1128676852-4096.gwf L1:L-L1_LOSC_16_V2-1128676852-4096.gwf"
CHANNELS="H1:LOSC-STRAIN L1:LOSC-STRAIN"

# trigger parameters
TRIGGER_TIME=1128678900.44
...
PSD_STRIDE=4
PSD_DATA_LEN=1024
PSD_GATE="H1:1128678900.0:2.0:0.5 L1:1128678900.0:2.0:0.5"
