...
# The output file from running pycbc_inference using the sample script pycbc-inference-paper/run_files/GW150914/run_pycbc_inference.sh is gw150914_posteriors.hdf . We then thin the samples and store them in gw150914_posteriors_thinned.hdf .

input_file=gw150914_posteriors.hdf
...
pycbc_inference_extract_samples --verbose \
    --output-file gw150914_posteriors_thinned.hdf \
